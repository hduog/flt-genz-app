...
mixin _$IsFollowDataOtherAccount {
  ...
  @JsonKey(name: 'followShipId')
  String? get followShipId => throw _privateConstructorUsedError;
  @JsonKey(name: 'followShipIdOfFollowing')
  String? get followShipIdOfFollowing => throw _privateConstructorUsedError;
  @JsonKey(name: 'followShipIdOfFollower')
  String? get followShipIdOfFollower => throw _privateConstructorUsedError;
...
class _$IsFollowDataOtherAccountCopyWithImpl<$Res,
  ...
  $Res call({
    ...
    Object? followShipId = freezed,
    Object? followShipIdOfFollowing = freezed,
    Object? followShipIdOfFollower = freezed,
  }) {
    return _then(_value.copyWith(
      ...
      message: freezed == message
          ...
          : message // ignore: cast_nullable_to_non_nullable
              as String?,
      followShipId: freezed == followShipId
          ? _value.followShipId
          : followShipId // ignore: cast_nullable_to_non_nullable
              as String?,
      followShipIdOfFollowing: freezed == followShipIdOfFollowing
          ? _value.followShipIdOfFollowing
          : followShipIdOfFollowing // ignore: cast_nullable_to_non_nullable
              as String?,
      followShipIdOfFollower: freezed == followShipIdOfFollower
          ? _value.followShipIdOfFollower
          : followShipIdOfFollower // ignore: cast_nullable_to_non_nullable
              as String?,
    ) as $Val);
  }
}
...
class _$IsFollowDataOtherAccountImpl implements _IsFollowDataOtherAccount {
  _$IsFollowDataOtherAccountImpl(
      ...
      @JsonKey(name: 'followShipId') this.followShipId,
      @JsonKey(name: 'followShipIdOfFollowing') this.followShipIdOfFollowing,
      @JsonKey(name: 'followShipIdOfFollower') this.followShipIdOfFollower});
  ...
  @override
  @JsonKey(name: 'followShipId')
  final String? followShipId;
  @override
  @JsonKey(name: 'followShipIdOfFollowing')
  final String? followShipIdOfFollowing;
  @override
  @JsonKey(name: 'followShipIdOfFollower')
  final String? followShipIdOfFollower;

  @override
  String toString() {
    return 'IsFollowDataOtherAccount(status: $status, message: $message, followShipId: $followShipId, followShipIdOfFollowing: $followShipIdOfFollowing, followShipIdOfFollower: $followShipIdOfFollower)';
  }
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            ...
            (identical(other.followShipId, followShipId) ||
                other.followShipId == followShipId) &&
            (identical(
                    other.followShipIdOfFollowing, followShipIdOfFollowing) ||
                other.followShipIdOfFollowing == followShipIdOfFollowing) &&
            (identical(other.followShipIdOfFollower, followShipIdOfFollower) ||
                other.followShipIdOfFollower == followShipIdOfFollower));
  }

  @JsonKey(includeFromJson: false, includeToJson: false)
  @override
  int get hashCode => Object.hash(runtimeType, status, message, followShipId,
      followShipIdOfFollowing, followShipIdOfFollower);
...
abstract class _IsFollowDataOtherAccount implements IsFollowDataOtherAccount {
  factory _IsFollowDataOtherAccount(
      ...
      @JsonKey(name: 'followShipId') final String? followShipId,
      @JsonKey(name: 'followShipIdOfFollowing')
      final String? followShipIdOfFollowing,
      @JsonKey(name: 'followShipIdOfFollower')
      final String? followShipIdOfFollower}) = _$IsFollowDataOtherAccountImpl;
  ...
  @override
  @JsonKey(name: 'followShipId')
  String? get followShipId;
  @override
  @JsonKey(name: 'followShipIdOfFollowing')
  String? get followShipIdOfFollowing;
  @override
  @JsonKey(name: 'followShipIdOfFollower')
  String? get followShipIdOfFollower;
